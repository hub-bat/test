...
<html lang="en">
  <head>
    ...
    <meta property="og:image" content="https://homestuck.net/img/tools/rlabs-sburb-title.png" />
	...
	<script async src='https://www.googletagmanager.com/gtag/js?id=G-LEM4S5W3T6'></script> <script> window.dataLayer = window.dataLayer || []; function gtag(){dataLayer.push(arguments);} gtag('js', new Date()); gtag('config', 'G-LEM4S5W3T6'); </script></head>
<body>
